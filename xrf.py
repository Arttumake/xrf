...
for num, file in enumerate(csv_files):
    with open(file) as csv_file:
        ...
        for row in ws.iter_rows(min_row=substance_row + 2, max_row=substance_row + 2, min_col=1):
            for cell in row:
        ...
        for rows in ws.iter_rows(min_row=substance_row, max_row=substance_row, min_col=offset + 1):
